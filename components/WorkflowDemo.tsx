...
export default function WorkflowDemo({ activeStep }: WorkflowDemoProps) {
  ...
  const renderStep1 = () => (
    <div className="space-y-6">
      <div>
        <label className="text-sm text-slate-400 mb-2 block">Intent Statement</label>
      ...
      <div>
        <label className="text-sm text-slate-400 mb-2 block">Total Amount</label>
        <div className="bg-gradient-to-r from-blue-500/20 to-cyan-500/20 rounded-xl p-6 border border-blue-500/30">
          <p className="text-3xl font-bold text-blue-400">3.0 ETH</p>
        </div>
      </div>

      <div>
        <label className="text-sm text-slate-400 mb-2 block">Beneficiaries</label>
        <div className="space-y-2">
          <div className="bg-slate-800/50 rounded-lg p-3 border border-slate-700/50 flex justify-between items-center">
            ...
            <span className="text-blue-400 font-semibold">1.5 ETH (50%)</span>
          </div>
          <div className="bg-slate-800/50 rounded-lg p-3 border border-slate-700/50 flex justify-between items-center">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-gradient-to-br from-blue-500/20 to-blue-600/20 rounded-xl p-4 border border-blue-500/30">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs text-slate-300">Inactivity Period</span>
          </div>
        ...
        <div className="bg-gradient-to-br from-purple-500/20 to-purple-600/20 rounded-xl p-4 border border-purple-500/30">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs text-slate-300">Delay Window</span>
          </div>
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-gradient-to-br from-blue-500/20 to-blue-600/20 rounded-xl p-4 border border-blue-500/30">
          ...
          <p className="text-xs text-slate-400">No activity detected for this duration</p>
        </div>
        ...
        <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/50">
          ...
          <p className="text-xs text-slate-400">Grace period before execution</p>
        </div>

        <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/50">
          <div className="flex items-center gap-2 mb-2">
            <User className="w-4 h-4 text-slate-400" />
            <span className="text-xs text-slate-300">Last Activity</span>
          </div>
          <p className="text-lg font-bold text-white mb-1 font-mono">0x5a3b...2F1c</p>
          <p className="text-xs text-slate-400">Wallet address to monitor</p>
        </div>

        <div className="bg-gradient-to-br from-red-500/20 to-red-600/20 rounded-xl p-4 border border-red-500/30">
          <div className="flex items-center gap-2 mb-2">
            <Calendar className="w-4 h-4 text-red-400" />
            <span className="text-xs text-slate-300">Estimated Trigger Time</span>
          </div>
          <p className="text-2xl font-bold text-white mb-1">Jan 15, 2026</p>
          <p className="text-xs text-slate-400">If no activity until this date</p>
        </div>
      </div>
    ...
    <div className="space-y-6">
      {isExecuting ? (
        <div className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-xl p-8 border border-blue-500/30 text-center">
          ...
          <p className="text-sm text-slate-300">Conditions met. Transferring assets...</p>
        </div>
      ) : isCompleted ? (
        <>
          <div className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-xl p-8 border border-blue-500/30 text-center">
            ...
            <p className="text-sm text-slate-300">Assets have been successfully transferred</p>
          </div>
  ...
  return (
    <div className="w-full h-full bg-slate-900/80 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-8">
      {/* Step Indicator */}
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400">Step {currentStep} of 4</p>
        </div>
      </div>
